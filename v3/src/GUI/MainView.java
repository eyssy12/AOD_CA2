...
{    
    ...
    public MainView(Controller controller, Model model)
    {
        ...
        this.spnrHour = new JSpinner(new SpinnerNumberModel(0, 0, 23, 1));
        this.lblMinute = new JLabel();
        this.spnrMinute = new JSpinner(new SpinnerNumberModel(0, 0, 59, 1));
        ...
        this.tableModel = new ThreadTableModel(this.model);
        ...
        this.txtInput.setText("http://www.sem-o.com/marketdata/Pages/PricingAndScheduling.aspx");
        ...
        this.btnEnter.setBounds(10, 55, 80, 23);
        ...
        this.btnSelectPath.setBounds(100, 55, 120, 23);
        ...
        this.scrlPathDisplay.setBounds(10, 85, 270, 60);
        ...
        this.pnlUrlInfo.setBounds(10, 10, 710, 150);
        ...
        this.lblHour.setText("Hour(0-23)");
        this.pnlManager.add(this.lblHour);
        this.lblHour.setBounds(70, 70, 80, 20);
        ((JSpinner.DefaultEditor) this.spnrHour.getEditor()).getTextField().setEditable(false);
        this.pnlManager.add(this.spnrHour);
        this.spnrHour.setBounds(20, 70, 38, 20);
        
        this.lblMinute.setText("Minute(0-59)");
        this.pnlManager.add(this.lblMinute);
        this.lblMinute.setBounds(70, 110, 80, 20);
        ((JSpinner.DefaultEditor) this.spnrMinute.getEditor()).getTextField().setEditable(false);
        this.pnlManager.add(this.spnrMinute);
        this.spnrMinute.setBounds(20, 110, 38, 20);
        ...
        this.pnlManager.setBounds(10, 170, 180, 270);
        
        this.datePicker = new JXDatePicker();
        this.datePicker.setBounds(20, 150, 100, 20);
        this.pnlManager.add(this.datePicker);
        ...
        this.btnStop.setBounds(175, 230, 150, 25);
        ...
        this.pnlThreadTable.setBounds(220, 170, 500, 270);
    }
    ...
    public JSpinner getSpnrHour()
    {
    	return this.spnrHour;
    }
    
    public JSpinner getSpnrMinute()
    {
    	return this.spnrMinute;
    }
}
